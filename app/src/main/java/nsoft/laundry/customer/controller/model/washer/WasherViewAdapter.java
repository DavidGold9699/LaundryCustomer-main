package nsoft.laundry.customer.controller.model.washer;
...
public class WasherViewAdapter extends RecyclerView.Adapter<WasherViewAdapter.ViewHolder> {
    ...
    public WasherViewAdapter(Context context, List<String> machineNo, List<String> machineStatus) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_washer, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (strMachineStatus.equals("AVAILABLE")){
            holder.layMachine.setBackgroundDrawable(ContextCompat.getDrawable(mInflater.getContext(), R.drawable.img_washer_available));
        }
